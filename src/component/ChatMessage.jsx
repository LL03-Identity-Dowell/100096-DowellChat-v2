        ...
        <div className={`${message?.isSender ? 'self-end' : 'self-start'}`}>
                ...
                message?.type == 'image' ? (
                    <div className="w-60 mx-10 my-5">
                        ...
                        <div className={`${message?.isSender ? 'bg-green-300 rounded-full rounded-tr' : 'bg-blue-300 rounded-full rounded-tl self-start'} flex items-center text-black/50 shadow-lg py-2 px-3`}>
